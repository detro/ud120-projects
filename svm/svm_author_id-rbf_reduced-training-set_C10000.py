...
print 'Prediction for feature #10 => {0}'.format(predictions[10])
print 'Prediction for feature #26 => {0}'.format(predictions[26])
print 'Prediction for feature #50 => {0}'.format(predictions[50])
